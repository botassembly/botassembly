...
describe.each([
  ...
  ["rejects run_end one millisecond before run_start", [{ ...start, ts: "2026-09-04T10:00:00.001Z" }, runEnd], "invalid"],
  ["accepts run_end equal to run_start", [start, runEnd], "valid"],
  ["accepts run_end after run_start", [start, { ...runEnd, ts: "2026-09-04T10:00:00.001Z" }], "valid"],
