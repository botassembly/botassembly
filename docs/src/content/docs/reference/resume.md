...
Donor requests may contain at most 4 MiB. Bot refuses a larger historical donor before creating any new run artifact. Raw request inspection remains available without this limit.
