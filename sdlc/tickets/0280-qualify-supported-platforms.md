...
- Production code expected: One small platform admission function and its first call at CLI entry.
- Production code avoided: No platform abstraction layer, process emulation, output rewrite, cleanup retry system, provider wrapper, or native Windows implementation.
