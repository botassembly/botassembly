...
The named Vitest platform set uses one worker. This reduces concurrent test memory use on hosted macOS without changing its owners or repeating the main set.
