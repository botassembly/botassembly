...
- Ending production size: 19675 nonblank lines
- Production ceiling: 19675 nonblank lines. The implementation stayed below the accepted 19708-line maximum, so the ratchet uses the measured total.
