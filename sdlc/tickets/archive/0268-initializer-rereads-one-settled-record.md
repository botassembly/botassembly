...
- Code review: accepted after one rejection. The first harness could accept a prematurely closed stream, let forced errors override a deadline, update a finalized hash, leak thrown IPC operations, and accept any IPC message as ready. Thirty-eight focused cases prove the repaired failure boundaries.
